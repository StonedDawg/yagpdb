...
func createInteractiveHelp(userID int64, helpEmbeds []*discordgo.MessageEmbed) (interface{}, error) {
	...
	firstPage := &discordgo.MessageEmbed{
		Title: "STONEDBOT Help!",
		Description: fmt.Sprintf(`STONEDBOT is an open-source multipurpose discord bot that is configured through the web interface at stonedbot cpanel.
